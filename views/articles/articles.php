        ...
        <div class="newsfeed">
            ...
            <div style="display: inline-block;">
                ...
                <p style="font-size: 16px;margin-left: 175px;">
                    <a href="?main=articles&refs=an-idea-whose-time-has-come"><b style="font-size: 20px;">An idea whose time has come</b></a><br><br>
            ...
            <div style="display: inline-block;">
                ...
                <p style="font-size: 16px;margin-left: 170px;">
                    <a href="?main=articles&refs=a-promise-yet-to-be-fulfilled"><b style="font-size: 20px;">A promise yet to be fulfilled</b></a><br><br>
